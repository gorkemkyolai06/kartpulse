  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background p-4 py-8">
      <div className="mb-6 text-center">
        <div className="mx-auto mb-3 flex h-14 w-14 items-center justify-center border-l-4 border-l-accent bg-primary text-primary-foreground shadow-sm">
          <Flag className="h-7 w-7 text-accent" strokeWidth={2} />
        </div>
        <h1 className="font-display text-3xl tracking-wide">Pist Kaydı</h1>
      </div>

      <Card className="pit-card w-full max-w-lg">
        <CardHeader>
          <CardTitle className="font-display text-2xl normal-case">Yeni Go-Kart Pisti Oluştur</CardTitle>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="kartTrackName">Pist Adı</Label>
              <Input
                id="kartTrackName"
                value={form.kartTrackName}
                onChange={(e) => update('kartTrackName', e.target.value)}
                required
                placeholder="Velocity Kart Track"
              />
            </div>
            <div className="space-y-2">
