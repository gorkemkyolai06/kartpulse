...
export class RateTiersController {
  ...
  list(
    ...
    return this.rateTiersService.list(req.user.kartTrackId, {
  ...
  get(@Request() req: { user: { kartTrackId: string } }, @Param('id') id: string) {
    return this.rateTiersService.get(req.user.kartTrackId, id);
  }
  ...
  create(
    ...
    return this.rateTiersService.create(req.user.kartTrackId, dto);
  }
  ...
  update(
    ...
    return this.rateTiersService.update(req.user.kartTrackId, id, dto);
  }

  @Delete(':id')
  remove(@Request() req: { user: { kartTrackId: string } }, @Param('id') id: string) {
    return this.rateTiersService.remove(req.user.kartTrackId, id);
  }
}
